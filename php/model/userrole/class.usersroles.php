...
require_once( __dir__ . '/class.usersrolesdao.php' ) ;

class UsersRoles extends UsersRolesDao
{
    private $allowedKeys = [ 'user_id' , 'username' , 'email' , 'role_id' , 'name' ] ;

    function __construct ( ...$args )
    {   // echo 'class Roles extends RolesDao __construct' . \PHP_EOL ;
        // print_r( $args ) ;
