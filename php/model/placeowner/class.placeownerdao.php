...
class PlaceOwnerDao extends Setup
{
    private $functions = null ;
    protected $values = [] ;
    
    function __construct ()
    {   // echo 'class PlaceOwnerDao extends Setup __construct' . \PHP_EOL ;
    ...
    protected function update( string $key , $value ) 
        {
            ...
            $rowCount = $this->functions->update( $this->values['place_owner_id'] , $key , $value ) ;
        return [ $rowCount , $oldValue ] ; }

    public function delete()
        {
            $rowCount = $this->functions->delete( $this->values['place_owner_id'] ) ;
            $this->values = null ;
        return $rowCount ; }
