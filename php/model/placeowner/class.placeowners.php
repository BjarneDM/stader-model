...
require_once( __dir__ . '/class.placeownersdao.php' ) ;

class PlaceOwners extends PlaceOwnersDao
{
    private $allowedKeys = [ 'name' , 'surname' , 'phone' , 'email' , 'organisation' ] ;
    ...
    {   // echo 'class User extends UserDao __construct' . \PHP_EOL ;
        ...
        /*
         *  gettype( $args[0] ) === 'null' 
         *      hent alle placeowners
         *      $testUser = new PlaceOwners() ;
         *  gettype( $args[0] ) === 'array' | 'string'
         *      hent alle placeowners på basis af værdierne i $args[0] , $args[1] 
         *      $testUser = new PlaceOwners($args[0] , $args[1] )
         */
